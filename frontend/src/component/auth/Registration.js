...
const Register = () => {
  ...
  const submitData = (e) => {
    ...
    if (validateForm()) {
      ...
      const url = 'http://localhost/React/frontend/Admin/connection/login/register.php';
  
      axios
        .post(url, formData) // Sending formData to the server
        .then((response) => {
        ...
        <div className="billing-details">
          ...
          <form className="checkout-form" onSubmit={submitData}>
            ...
            <div className="new-account text-center mt-20">
              <span style={{color:'black',fontFamily:'bold',fontSize:'120%'}}>Already have an account with us</span>
              <a style={{cursor: 'pointer', textdecoration: 'none', color:'green',fontFamily:'bold',fontSize:'150%'}}
                className="link"
