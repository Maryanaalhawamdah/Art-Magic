...
export default function Profile() {
  ...
  useEffect(() => {
    // Fetch user data
    axios
      .post("http://localhost/React/frontend/phppages/profilephp/viewProfile.php", {
    ...
    // Fetch order data
    axios
      .post("http://localhost/React/frontend/phppages/profilephp/orders.php", {
        id: localStorage.getItem("id"),
      })
      .then((response) => {
  ...
  const handleSaveChanges = () => {
    ...
    axios
      .post(
        "http://localhost/React/frontend/phppages/profilephp/update.php",
        updatedUser
      )
      .then((response) => {
